...
export default function Hero() {
  return (
    ...
    <div data-aos="flip-right" className="px-[15px] pb-[20px] pt-[50px] max-w-[1480px] m-auto bg-gradient-to-r mt-[75px] rounded-[50px]  from-purple-600 to-pink-500 text-white ">
